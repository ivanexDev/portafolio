...
function App() {
	...
	let transition = `h1-nombre ${transitionValue ? "h-transition" : ""}`;
	let transition2 = `h1-nombre2 ${transitionValue2 ? "h-transition" : ""}`;
	let transition3 = `h1-nombre3 ${transitionValue3 ? "h-transition" : ""}`;
	const dev = `<Dev/>`;
